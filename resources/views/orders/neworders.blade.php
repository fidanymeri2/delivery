...
.modal-footer .btn {
    ...
    <div class="container">
        ...
        <!-- New Orders -->
        <h2 class="status-new">{{ __('neworder.new_orders') }} <span id="newOrder">(0)</span></h2>
...
@endphp
        ...
        <!-- Delivered Orders -->
<h2 class="status-delivered">{{ __('neworder.delivered_orders') }} ({{ count($deliveredOrders) }})</h2>
        <div class="table-responsive">
           <table class="table table-bordered">
        <thead>
            <tr>
                <th>#</th>
                <th>{{ __('neworder.order_code') }}</th>
                <th>{{ __('neworder.full_name') }}</th>
                <th>{{ __('neworder.phone_number') }}</th>
                <th>{{ __('neworder.location') }}</th>
                <th>{{ __('neworder.email') }}</th>
                <th>{{ __('neworder.status_of_payment') }}</th>
                <th>{{ __('neworder.date') }}</th>
                <th>{{ __('neworder.actions') }}</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($deliveredOrders as $order)
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <p class="btn btn-primary">{{ __('neworder.delivery') }}: {{ $order->takenByUser->name ?? 'N/A' }}</p>
                    </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <!-- Completed Orders -->
<h2 class="status-complete">{{ __('neworder.completed_orders') }} ({{ count($completedOrders) }})</h2> 
        <div class="table-responsive">
          <table class="table table-bordered">
        <thead>
            <tr>
        ...
        <!-- Canceled Orders -->
        <h2 class="status-canceled">{{ __('neworder.canceled_orders') }} ({{ count($canceledOrders) }})</h2>
        <div class="table-responsive">
            <table class="table table-bordered">
        <thead>
            <tr>
