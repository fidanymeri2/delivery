<x-app-layout>
    ...
    <div class="container">
        <!--<x-button>-->
        <!--    <a href="{{ route('messages.create') }}" class="text-white no-underline hover:no-underline">Create New Message</a>-->
        <!--</x-button>-->
                ...
                <tbody>
                    @forelse ($messages as $message)
                        <tr>
                            ...
                            <td class="actions">
                                <a href="{{ route('messages.edit', $message) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
