                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="table_category_id" id="table_category_id" 
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('table_category_id', $selectedCategory) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" id="notes" rows="3" 
                                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                          placeholder="Any special notes about this table (e.g., window seat, corner table)">{{ old('notes') }}</textarea>
                            </div>
