<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Reposition Tables -') }} {{ $category->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="controls">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ $category->name }} - Table Positioning</h3>
                            <p class="text-sm text-gray-600">Drag and drop tables to reposition them within the boundary</p>
                        </div>
                        <div class="control-buttons">
                            <a href="{{ route('restaurant-tables.show-category', $category->id) }}" class="btn btn-secondary">
                                Back to Category
                            </a>
                    ...
                    <div class="reposition-container">
                        <div class="canvas-container" id="canvas">
                            ...
                            @foreach($tables as $table)
                                ...
                                @endphp
                                <div class="draggable-table {{ $table->status }}" 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            testSaveButton.addEventListener('click', function() {
                ...
                fetch('{{ route("restaurant-tables.test-save") }}', {
                    method: 'POST',
                    headers: {
            ...
            saveButton.addEventListener('click', function() {
                ...
                fetch('{{ route("restaurant-tables.save-positions") }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
