            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('table-orders.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Create New Order
                        </a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            ...
                                            @if($order->table->category)
                                                <span class="text-xs text-gray-500">({{ $order->table->category->name }})</span>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($order->payment_method)
                                                <div class="text-xs text-gray-500">{{ ucfirst(str_replace('_', ' ', $order->payment_method)) }}</div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('table-orders.show', $order) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                                @if($order->status === 'open')
                                                    <a href="{{ route('table-orders.edit', $order) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                @endif
                                                <form action="{{ route('table-orders.destroy', $order) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
