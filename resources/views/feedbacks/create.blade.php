<x-app-layout>
    ...
    <form action="{{ route('feedbacks.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="rating" name="rating" value="{{ old('rating') }}" min="1" max="5" required>
            @error('rating')
        ...
        <a href="{{ route('feedbacks.index') }}" class="back-link">Back to Feedbacks</a>
    </div>
</x-app-layout>
