...
<div class="container">
        <div class="column">
            ...
            <form action="<?php echo e(route('users.update', $user)); ?>" method="POST">
                ...
                <select name="banned"><option <?php if($user->banned == 0): ?> selected <?php endif; ?> value="0">Active</option><option <?php if($user->banned == 1): ?> selected <?php endif; ?> value="1">Inactive</option></select><br/>
...
<?php endif; ?><?php /**PATH /home/u397680723/domains/soltriks.com/public_html/testtt/resources/views/users/edit.blade.php ENDPATH**/ ?>