...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('messages.update', $message->id)); ?>" method="POST">
            ...
            <input type="text" name="category" id="category" value="<?php echo e(old('category', $message->category)); ?>" required>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\devi-back\resources\views/messages/edit.blade.php ENDPATH**/ ?>