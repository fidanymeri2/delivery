            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('description_categories.create')); ?>"
                                    ...
                                    <tr data-id="<?php echo e($category->id); ?>" class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                <a href="<?php echo e(route('description_categories.edit', $category)); ?>"
                                                ...
                                                <form action="<?php echo e(route('description_categories.destroy', $category)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="2" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                            No description categories found.
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
