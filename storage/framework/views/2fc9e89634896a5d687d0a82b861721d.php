...
<style>
    ...
    <div class="product-container">
                ...
                <tbody>
                    <?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($size->dimensions); ?></td>
        ...
        <div class="extra-products">
            ...
            <?php if($extraProducts->isEmpty()): ?>
                <p>No extra products available for this product.</p>
            <?php else: ?>
                <ul>
                    <?php $__currentLoopData = $extraProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extraProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <strong><?php echo e($extraProduct->name); ?></strong> - <?php echo e($extraProduct->price); ?> EUR 
                            <span class="category">(Category: <?php echo e($extraProduct->category->name); ?>)</span>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/products/show.blade.php ENDPATH**/ ?>