...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="container">
            <h1>Edit Extra Category</h1>
            <form action="<?php echo e(route('extra-categories.update', $extraCategory)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div>
                    <label for="name">Name:</label>
                    <input type="text" id="name" name="name" value="<?php echo e(old('name', $extraCategory->name)); ?>" required>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/extra-categories/edit.blade.php ENDPATH**/ ?>