                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('categories.create')); ?>"
                           class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            <?php echo e(__('category.create_new_category')); ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <?php echo e(__('category.description')); ?>

                                    </th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <?php echo e(__('category.actions')); ?>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <form action="<?php echo e(route('categories.destroy', $category->id)); ?>" method="POST" class="inline">
                                                    ...
                                                    <button type="submit"
                                                            ...
                                                            onclick="return confirm('<?php echo e(__('category.are_you_sure')); ?>')">
                                                        <?php echo e(__('category.delete')); ?>
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            alert('<?php echo e(__('category.order_updated_successfully')); ?>');
                        },
                        error: function(xhr, status, error) {
                            console.error('An error occurred:', xhr.responseText);
                            alert('<?php echo e(__('category.failed_to_update_order')); ?>' + xhr.responseText);
                        }
                    });
                }
            });
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\delivery\resources\views/categories/index.blade.php ENDPATH**/ ?>