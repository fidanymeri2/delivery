...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="container">
            ...
            <form method="POST" action="<?php echo e(route('extra-products.store')); ?>">
                <?php echo csrf_field(); ?>
...
<input type="text" name="price[<?php echo e($desc->id); ?>]" id="price" value="<?php echo e(old('prices.' . $desc->id)); ?>"> 
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/extra-products/create.blade.php ENDPATH**/ ?>