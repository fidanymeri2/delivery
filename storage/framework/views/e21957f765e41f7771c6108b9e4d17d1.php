    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('banners.update', $banner->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="checkbox" name="status" id="status" value="1" <?php echo e($banner->status ? 'checked' : ''); ?>>
                <p>Check to activate the banner.</p>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/banners/edit.blade.php ENDPATH**/ ?>