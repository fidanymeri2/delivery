                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold text-blue-600 mb-4">
                            <?php echo e(__('neworder.new_orders')); ?> <span id="newOrder" class="text-gray-600">(0)</span>
                        </h2>
                    ...
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold text-orange-600 mb-4">
                            <?php echo e(__('neworder.delivered_orders')); ?> (<?php echo e(count($deliveredOrders)); ?>)
                        </h2>
                        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">#</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.order_code')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.full_name')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.phone_number')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.location')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.email')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.status_of_payment')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.date')); ?></th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('neworder.actions')); ?></th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $deliveredOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->o++); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->order_code); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->firstName); ?> <?php echo e($order->lastName); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->phone_number); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->location); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->email); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->status_of_payment); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->created_at->format('Y-m-d')); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <a href="<?php echo e(route('orders.invoice', $order->id)); ?>"
                                                       ...
                                                       onclick="printInvoice(event, '<?php echo e(route('orders.invoice', $order->id)); ?>')">
                                                        Invoice
                                                    </a>
                                                    ...
                                                    <span class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md text-purple-700 bg-purple-100">
                                                        <?php echo e(__('neworder.delivery')); ?>: <?php echo e($order->takenByUser->name ?? 'N/A'); ?>
                    ...
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold text-green-600 mb-4">
                            <?php echo e(__('neworder.completed_orders')); ?> (<?php echo e(count($completedOrders)); ?>)
                        </h2>
                        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead class="bg-gray-50">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $completedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($c++); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->order_code); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->firstName); ?> <?php echo e($order->lastName); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->phone_number); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->location); ?></td>
                    ...
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold text-red-600 mb-4">
                            <?php echo e(__('neworder.canceled_orders')); ?> (<?php echo e(count($canceledOrders)); ?>)
                        </h2>
                        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead class="bg-gray-50">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $canceledOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($can++); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->order_code); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->firstName); ?> <?php echo e($order->lastName); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->phone_number); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->location); ?></td>
            ...
            function callApi() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        let x = 1;
                        let userRole = "<?php echo e(auth()->user()->role); ?>";
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\delivery\resources\views/orders/neworders.blade.php ENDPATH**/ ?>