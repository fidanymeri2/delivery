            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-8 p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <form action="<?php echo e(route('orders.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                            ...
                            <div>
                                ...
                                <select name="shipping_status" id="shipping_status" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <option value="delivered" <?php echo e(request('shipping_status') == 'delivered' ? 'selected' : ''); ?>>On the way</option>
                                    <option value="complete" <?php echo e(request('shipping_status') == 'complete' ? 'selected' : ''); ?>>Delivered</option>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <p class="text-sm text-gray-600">Total Orders: <span class="font-bold text-xl text-blue-600"><?php echo e($orders->total()); ?></span></p>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration); ?></td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->postal_code); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->status_of_payment); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <?php if($order->shipping_status == 'new'): ?>
                    ...
                    <div class="p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="text-center">
                                <a href="<?php echo e(route('orders.dailyPdf')); ?>"
                            ...
                            <div>
                                <form action="<?php echo e(route('orders.dateRangePdf')); ?>" method="POST" class="space-y-4">
                                    <?php echo csrf_field(); ?>
                                    <div>
                                        ...
                                        <select name="waiterId" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                            ...
                                            <optgroup label="Waiter">
                                                ...
                                                <?php $__currentLoopData = $waiters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="w-<?php echo e($waiter->id); ?>"><?php echo e($waiter->name); ?></option>
                                            ...
                                            <optgroup label="Delivery">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="d-<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </optgroup>
                                        </select>
                                    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\delivery\resources\views/orders/index.blade.php ENDPATH**/ ?>