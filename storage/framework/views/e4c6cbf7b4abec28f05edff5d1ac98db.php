    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div class="flex items-center justify-between px-6 py-2">
            ...
            <div class="flex items-center ">
                ...
                <!-- User Menu -->
                <div class="relative">
                    <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center space-x-2 p-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors">
        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <?php if(auth()->user()->hasRole('admin')): ?>
                    <!-- Dashboard -->
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'dashboard' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-tachometer-alt text-lg"></i>
                        <span class="font-medium">Dashboard</span>
                    </a>

                    <!-- Products -->
                    <a href="<?php echo e(route('products.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'products.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-box text-lg"></i>
                        <span class="font-medium">Products</span>
                    </a>

                    <!-- Categories -->
                    <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'categories.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-th text-lg"></i>
                        <span class="font-medium">Categories</span>
                    </a>

                    <!-- Extra Products -->
                    <a href="<?php echo e(route('extra-products.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'extra-products.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-boxes text-lg"></i>
                        <span class="font-medium">Extra Products</span>
                    </a>

                    <!-- Description Categories -->
                    <a href="<?php echo e(route('description_categories.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'description_categories.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-tags text-lg"></i>
                        <span class="font-medium">Description Categories</span>
                    </a>

                    <!-- Extra Categories -->
                    <a href="<?php echo e(route('extra-categories.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'extra-categories.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-layer-group text-lg"></i>
                        <span class="font-medium">Extra Categories</span>
                    </a>

                    <!-- Stock Management -->
                    <a href="<?php echo e(route('stock-management.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'stock-management.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-warehouse text-lg"></i>
                        <span class="font-medium">Stock Management</span>
                    </a>

                    <!-- New Orders -->
                    <a href="<?php echo e(route('orders.new')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'orders.new' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-bell text-lg"></i>
                        <span class="font-medium">New Orders</span>
                    </a>

                    <!-- Orders -->
                    <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'orders.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-shopping-cart text-lg"></i>
                        <span class="font-medium">Orders</span>
                    </a>

                    <!-- Reservations -->
                    <a href="<?php echo e(route('reservations.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'reservations.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-calendar text-lg"></i>
                        <span class="font-medium">Reservations</span>
                    </a>

                    <!-- Table Categories -->
                    <a href="<?php echo e(route('table-categories.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'table-categories.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-sitemap text-lg"></i>
                        <span class="font-medium">Table Categories</span>
                    </a>

                    <!-- Restaurant Tables -->
                    <a href="<?php echo e(route('restaurant-tables.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'restaurant-tables.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-table text-lg"></i>
                        <span class="font-medium">Restaurant Tables</span>
                    </a>

                    <!-- Table Orders -->
                    <a href="<?php echo e(route('table-orders.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'table-orders.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-utensils text-lg"></i>
                        <span class="font-medium">Table Orders</span>
                    </a>

                    <!-- POS System -->
                    <a href="<?php echo e(route('pos.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'pos.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
                        <i class="fas fa-cash-register text-lg"></i>
                        <span class="font-medium">POS System</span>
                    </a>

                    <!-- Settings -->
                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(Route::currentRouteName() == 'settings.index' ? 'bg-[#0d9488] text-white shadow-lg' : 'text-gray-700 hover:bg-gray-50 hover:text-[#0d9488]'); ?>">
...
<?php /**PATH C:\laragon\www\delivery\resources\views/layouts/app.blade.php ENDPATH**/ ?>