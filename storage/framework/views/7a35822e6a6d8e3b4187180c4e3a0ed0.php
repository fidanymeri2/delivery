...
<?php endif; ?>
<?php $component->withAttributes([]); ?>-->
        <!--    <a href="<?php echo e(route('messages.create')); ?>" class="text-white no-underline hover:no-underline">Create New Message</a>-->
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($message->category); ?></td>
                            <td><?php echo e($message->description); ?></td>
                            <td class="actions">
                                <a href="<?php echo e(route('messages.show', $message)); ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                <a href="<?php echo e(route('messages.edit', $message)); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                <form action="<?php echo e(route('messages.destroy', $message)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
...
$(function() {
    $("#sortable-messages").sortable({
        update: function(event, ui) {
            ...
            $.ajax({
                url: '<?php echo e(route("messages.sort")); ?>',
                method: 'POST',
                data: {
...
<?php /**PATH C:\laragon\www\devi-back\resources\views/messages/index.blade.php ENDPATH**/ ?>