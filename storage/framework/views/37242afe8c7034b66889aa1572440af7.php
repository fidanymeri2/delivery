                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div class="mt-6">
                                <?php echo e($users->appends(['waiter_page' => request('waiter_page')])->links()); ?>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <a href="<?php echo e(route('waiters.create')); ?>"
                                   class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    Create New Waiter
                                </a>
                            </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__empty_1 = true; $__currentLoopData = $waiters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900">
                                                        <?php echo e($waiter->pin_code); ?>

                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex items-center space-x-2">
                                                        <a href="<?php echo e(route('waiters.edit', $waiter)); ?>"
                                                           class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition ease-in-out duration-150">
                                                            <i class="fas fa-edit mr-1"></i> Edit
                                                        </a>
                                                        <form action="<?php echo e(route('waiters.destroy', $waiter)); ?>" method="POST" class="inline">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button type="submit"
                                                                    class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition ease-in-out duration-150"
                            ...
                            <div class="mt-6">
                                <?php echo e($waiters->appends(['user_page' => request('user_page')])->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\delivery\resources\views/users/index.blade.php ENDPATH**/ ?>