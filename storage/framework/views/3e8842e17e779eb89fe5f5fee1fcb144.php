...
<?php endif; ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td style="text-align: left;"><?php echo e($banner->description); ?></td>
                            ...
                            <td>
                                <a href="<?php echo e(route('banners.edit', $banner->id)); ?>" class="btn btn-primary btn-sm" title="Edit Banner"><i class="fas fa-edit"></i></a>
                                <form action="<?php echo e(route('banners.destroy', $banner->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm" title="Delete Banner"><i class="fas fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="back-link">Back to Dashboard</a>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/banners/index.blade.php ENDPATH**/ ?>