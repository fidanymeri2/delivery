                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold text-gray-900">
                            <?php echo e(__('category.create_category')); ?>

                        </h2>
                    </div>

                    <form action="<?php echo e(route('categories.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e(__('category.category_description')); ?> <span class="text-gray-500 font-light">(<?php echo e(__('category.optional')); ?>)</span>:
                            </label>
                            <textarea name="description" id="description" rows="4"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"><?php echo e(old('description')); ?></textarea>
                        </div>
                        ...
                        <div class="flex items-center justify-end space-x-3">
                            ...
                            <button type="submit"
                                ...
                                <?php echo e(__('category.save_category')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\delivery\resources\views/categories/create.blade.php ENDPATH**/ ?>