...
<?php $component->withAttributes([]); ?>
    ...
    <div class="select-product-container">
        ...
        <div class="breadcrumb" style="margin-bottom: 1rem; color: #64748b; font-size: 0.875rem;">
            <a href="<?php echo e(route('dashboard')); ?>" style="color: #3b82f6; text-decoration: none;">Dashboard</a>
            <span style="margin: 0 0.5rem;">›</span>
            <a href="<?php echo e(route('stock-management.index')); ?>" style="color: #3b82f6; text-decoration: none;">Stock Management</a>
            <span style="margin: 0 0.5rem;">›</span>
        ...
        <div class="tab-navigation">
            <a href="<?php echo e(route('stock-management.select-product', ['tab' => 'stock-needed'])); ?>" 
               class="tab-button <?php echo e($tab === 'stock-needed' ? 'active' : ''); ?>">
                📦 Products with Stock Tracking (<?php echo e(App\Models\Product::where('requires_stock', true)->count()); ?>)
            </a>
            <a href="<?php echo e(route('stock-management.select-product', ['tab' => 'no-stock-needed'])); ?>" 
               class="tab-button <?php echo e($tab === 'no-stock-needed' ? 'active' : ''); ?>">
                ❌ Products without Stock Tracking (<?php echo e(App\Models\Product::where('requires_stock', false)->count()); ?>)
            </a>
        </div>
        ...
        <div class="products-grid" id="productsGrid">
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="product-card" 
                     ...
                     data-status="<?php echo e($product->getStockStatus()); ?>">
                    <div class="product-header">
                        <div>
                            <div class="product-name"><?php echo e($product->name); ?></div>
                            <div class="product-category"><?php echo e($product->category->name ?? 'No Category'); ?></div>
                        </div>
                    </div>
                    ...
                    <?php if($tab === 'stock-needed'): ?>
                        <div class="stock-info">
                            ...
                            <div class="stock-status status-<?php echo e($product->getStockStatus()); ?>">
                                <?php echo e(ucfirst(str_replace('_', ' ', $product->getStockStatus()))); ?>

                            </div>
                        </div>
                        
                        <div class="button-group">
                            <a href="<?php echo e(route('stock-management.adjust-stock', $product)); ?>" class="adjust-button">
                                Adjust Stock
                            </a>
                            <form action="<?php echo e(route('stock-management.disable-tracking', $product)); ?>" method="POST" style="flex: 1;" onsubmit="return confirmDisableStock('<?php echo e($product->name); ?>')">
                                <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="button-group">
                            <form action="<?php echo e(route('stock-management.enable-tracking', $product)); ?>" method="POST" style="flex: 1;" onsubmit="return confirmEnableStock('<?php echo e($product->name); ?>')">
                                <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="empty-state">
                    <div class="empty-state-icon"><?php echo e($tab === 'stock-needed' ? '📦' : '❌'); ?></div>
...
<?php endif; ?> <?php /**PATH C:\laragon\www\delivery\resources\views/stock-management/select-product.blade.php ENDPATH**/ ?>