...
<div class="container">
    ...
    <!-- Filter form -->
    <form action="<?php echo e(route('orders.deliverystats')); ?>" method="GET" class="mb-4">
        <div class="row">
            <div class="col-md-3">
                <label for="delivery_user"><?php echo e(__('delivery_stats.filter_by_delivery_user')); ?></label>
                <select name="delivery_user" id="delivery_user" class="form-control">
                    <option value=""><?php echo e(__('delivery_stats.select_delivery_user')); ?></option>
                    <?php $__currentLoopData = $deliveryUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($user->id); ?>" <?php echo e(request('delivery_user') == $user->id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-3">
                <label for="start_date"><?php echo e(__('delivery_stats.start_date')); ?></label>
                <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo e(request('start_date')); ?>">
            </div>

            <div class="col-md-3">
                <label for="end_date"><?php echo e(__('delivery_stats.end_date')); ?></label>
                <input type="date" name="end_date" id="end_date" class="form-control" value="<?php echo e(request('end_date')); ?>">
            </div>

            <div class="col-md-3">
                <button type="submit" class="btn btn-primary mt-4"><?php echo e(__('delivery_stats.filter_button')); ?></button>
            </div>
        </div>
    </form>
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="<?php echo e(route('orders.deliverystats.pdf', request()->query())); ?>" class="btn btn-info mb-4">
                <span class="icons"><i class="fas fa-file-pdf"></i></span>
                <?php echo e(__('delivery_stats.export_pdf')); ?>

            </a>
            <?php if($filteredOrders->count()): ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $filteredOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(ucfirst($order->shipping_status)); ?></td>
                                <td><?php echo e($order->created_at->format('Y-m-d')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
                <?php echo e($filteredOrders->links()); ?>

            <?php else: ?>
                <p><?php echo e(__('delivery_stats.no_orders_found')); ?></p>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php endif; ?><?php /**PATH /home/u397680723/domains/soltriks.com/public_html/testtt/resources/views/orders/deliverystats.blade.php ENDPATH**/ ?>