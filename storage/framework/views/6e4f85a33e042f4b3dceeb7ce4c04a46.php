<li id="menu-item-<?php echo e(implode('-', array_merge($parentIndices, [$item->id]))); ?>">
    ...
    <ul id="nested-items-<?php echo e(implode('-', array_merge($parentIndices, [$item->id]))); ?>">
        <?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('menu.menu-item', ['item' => $child, 'parentIndices' => array_merge($parentIndices, [$item->id])], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
</li><?php /**PATH C:\laragon\www\delivery\resources\views/menu/menu-item.blade.php ENDPATH**/ ?>