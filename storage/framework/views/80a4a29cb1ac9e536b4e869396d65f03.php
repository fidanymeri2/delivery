...
Display:flex;gap:25px;
    ...
    <form action="<?php echo e(route('menu.store')); ?>" method="POST">
                    <input type="hidden"  name="product_id" value="<?php echo e(request()->id); ?>" required>
...
?>
<h1 style="font-size:26px; font-weight:bold;"><a href="<?php echo e(route('products.edit',request()->id)); ?>">❮</a> <?php echo e($product->name); ?><h1><br/>
...
<div class="col-md-4">
            ...
            <input type="number" step="any"  id="<?php echo e($desc->id); ?>" name="price[<?php echo e($desc->id); ?>]" required>
</div>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/menu/create.blade.php ENDPATH**/ ?>