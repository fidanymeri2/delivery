...
<?php $component->withAttributes([]); ?>
    ...
    <h1 class="text-2xl font-bold mb-6"><?php echo e(__('category.title')); ?></h1>

        <form action="<?php echo e(route('categories.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>

            <div>
            <label for="name" class="block text-sm font-medium text-gray-700"><?php echo e(__('category.name')); ?>:</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <?php echo e(__('category.description')); ?> <span class="text-gray-500 font-light">(<?php echo e(__('category.optional')); ?>)</span>:
                </label>
            ...
            <?php echo e(__('category.create_button')); ?>
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/testtt/resources/views/categories/create.blade.php ENDPATH**/ ?>