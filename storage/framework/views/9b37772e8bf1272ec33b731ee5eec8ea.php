...
<style>
    ...
    <div class="max-w-4xl mx-auto p-6">
        <div class="breadcrumb">
            <a href="<?php echo e(route('extra-products.index')); ?>">Extra Products</a>
        ...
        <div class="container">
            ...
            <form action="<?php echo e(route('extra-products.update', $extraProduct->id)); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $extraProduct->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" required><?php echo e(old('description', $extraProduct->description)); ?></textarea>
                </div>
...
<?php $price = App\Models\ExtraProductPrice::where("extra_product_id", $extraProduct->id)->where("desc_id",$desc->id)->first(); ?>
                <div>
                    <label for="price">Price - <?php echo e($desc->name); ?></label>
<input type="text" name="price[<?php echo e($price->id); ?>]" id="price" value="<?php echo e(old('prices.' . $price->id, $price->price)); ?>"> 
...
<?php endif; ?>
<?php /**PATH /home/u397680723/domains/soltriks.com/public_html/apiyumiis/resources/views/extra-products/edit.blade.php ENDPATH**/ ?>